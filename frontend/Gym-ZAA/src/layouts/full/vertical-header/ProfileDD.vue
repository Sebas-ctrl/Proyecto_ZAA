...
<template>
    ...
    <v-menu :close-on-content-click="false">
        ...
        <v-sheet rounded="md" width="360" elevation="10">
            <div class="px-8 pt-6">
                <h6 class="text-h5 font-weight-medium">Perfil de usuario</h6>
                <div class="d-flex align-center mt-4 pb-6">
                    <v-avatar size="80">
                        <img src="@/assets/images/profile/user2.jpg" width="80" />
                    </v-avatar>
                    <div class="ml-3">
                        <h6 class="text-h6 mb-n1">Ameli Pérez</h6>
                        <!-- <span class="text-subtitle-1 font-weight-regular textSecondary">Designer</span> -->
                        <div class="d-flex align-center mt-1">
                            <MailIcon size="18" stroke-width="1.5" />
                            <span class="text-subtitle-1 font-weight-regular textSecondary ml-2">ame@gmail.com</span>
                        </div>
                    </div>
                </div>
                <v-divider></v-divider>
